...
(function() {
  ...
  var FURNITURE = [
    ...
    [7.29,  1.35, '난방수 분배기'],       // @FURN#74 벽 94 중앙 (z=1.35), 벽에서 앞 30cm, 두께 30cm (서측 7.14 ~ 동측 7.44) — 5/8 미팅 결정 (meetingOnly)
  ];
  ...
  var FURNITURE_BBOX = [
    ...
    [7.14,  1.10,  7.44,  1.60, 0.10, 0.50],// @FURN#74 난방수 분배기 — 벽 94 중앙, 벽에서 앞 30cm 당김, 두께 30cm (D 두 배) — 주방 하부장(우) @FURN#52 BEHIND, meetingOnly
  ];
