...
(function() {
  ...
  var DOORS = [
    ...
    // 닫힘 위치 기준 좌표. 클릭 시 3 패널 모두 함께 +z 방향 슬라이드 (북쪽 적층).
    [7.770, 2.95,   '영림 중문 패널 1 (남)'], // @DOOR#49 _doors[33]  닫힘 z=2.70~3.20, 열림 시 +1.0m → z=3.70~4.20
    [7.800, 3.45,   '영림 중문 패널 2 (중)'], // @DOOR#50 _doors[34]  닫힘 z=3.20~3.70, 열림 시 +0.5m → z=3.70~4.20
    [7.830, 3.95,   '영림 중문 패널 3 (북)'], // @DOOR#51 _doors[35]  닫힘 z=3.70~4.20, 정지 (적층 기준 위치)
  ];
