/* =====================================================================
   POWER PLAN MODE — 사용자 요청 (숫자 2 토글, 이전 숫자 1, CL 50974 에서 변경)
   ----------------------------------------------------------------------
   본 파일은 사용자 요청 (CL 50409, S1 리팩토링) 으로 index.html 인라인 2 에서
   분리된 전원 계획 모드 로직. 토글 키는 1→2 로 변경 (CL 50974) — 1 은
   5/8 미팅 결정사항 모드 (meetingmode.js, CL 50995) 로 사용.
...
//   양 모드가 같은 시각 필터를 공유하기 위해 추출 (CL 50995).
