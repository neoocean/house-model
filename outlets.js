...
const OUTLETS = [
  ...
  // ── 침실 1 (방 7) ───────────────────────────────────────────────
  { x: xHall - WT/2, y: 0.40, z: 0.50,     face: 'W', gangs: 2, label: '침실1 책상 좌' },
  { x: xHall - WT/2, y: 0.40, z: 2.20,     face: 'W', gangs: 2, label: '침실1 남쪽' },
  // 벽 82 (침실1 북쪽 외벽 x=7.8~10.5, z=0) — 사용자 재요청에 따라 좌측 단일 2구로 축소.
  // 4구(0.288 m) 는 책꽂이(@FURN#64/65, x=8.04~10.44) 와 우측 끝 좁은 갭(0.06 m) 에 안 맞음.
  // 좌측 갭 (x=7.80~8.04) 에 2구(0.144 m) 만 fit.
  { x: 7.95,  y: 1.06, z: WT/2,           face: 'N', gangs: 2, label: '침실1 북측 (벽 82, 좌측)' },
  // ── 침실 2 (방 9) ───────────────────────────────────────────────
  ...
  { x: xKit + WT/2, y: 0.40, z: 5.70,      face: 'E', gangs: 1, kind: 'wet', label: '욕실 비데용' },
  // 휴지걸이 (@FURN#56) 왼쪽 아래 — 욕실 좌벽 z=5.50, y=0.40
  { x: xKit + WT/2, y: 0.40, z: 5.50,      face: 'E', gangs: 1, kind: 'wet', label: '욕실 휴지걸이 좌측 하부' },
